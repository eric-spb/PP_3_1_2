...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        createUserIfNotExists("Admin User", 30, "admin@admin.com", "admin", Set.of(adminRole, userRole));
        createUserIfNotExists("Regular User", 25, "user@user.com", "user", Set.of(userRole));
        createUserIfNotExists("Test User", 20, "test@test.com", "test", Set.of(userRole));
    }
